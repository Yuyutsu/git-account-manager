...
2. Select option `4` (Fix repository remote URL)
...
Use option `5` in the menu to test if your SSH key is properly configured with GitHub/GitLab. You should see a success message like:
